...
def main():
    ...
    rest = None
    line_number = -1  # Initial value for type-checking (The for loop always runs.)
    line = ""  # Initial value for type-checking
    ...
    if GITHUB_OUTPUT is not None:
        with GITHUB_OUTPUT.open("w") as fh:
            print(f"{new_docker_tag=}", file=fh)
